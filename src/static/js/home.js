...
function forexFunc(){
    document.getElementById('forex').scrollIntoView({behavior:"smooth"});
 }

function digitalCurrencyFunc(){
    document.getElementById('digital-currency').scrollIntoView({behavior:"smooth"});
 }

 function bourseFunc(){
    document.getElementById('bourse').scrollIntoView({behavior:"smooth"});
 }
